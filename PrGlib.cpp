...
long PrGlib::PrG_get_size()const
{
...
ZZZ PrGlib::PrG_generate_strong_prime()
{
    /*STEP1: Generate two other primes: P-- and p+*/
    ZZZ p_sub_sub,p_plus;
    long size_prime=PrG_length;
...
void PrGlib::PrG_set_size(unsigned long size_prime)
{
